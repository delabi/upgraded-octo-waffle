                        ...
                        <header className="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                            <div className="flex lg:justify-center lg:col-start-2">
                                ...
                                <img
                                    ...
                                    width="100"
                                    // className="absolute -left-20 top-0 max-w-[877px]"
                                    src="https://halihealthservices.com/HaliPROLogoSQ.png"
                                />
                        ...
                        <main className="mt-6">
                            <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                ...
                                >
                                    ...
                                    >
                                        <img
                                            src="https://halihealthservices.com/HaliProMockUp1.jpg"
                                            alt="HaliPro screenshot"
                                        ...
                                        <div id="docs-card-content" className="flex items-start gap-6 lg:flex-col">
                                            ...
                                            <div className="pt-3 sm:pt-5 lg:pt-0">
                                                <h2 className="text-xl font-semibold text-black dark:text-white">
                                                    Based on the Guidelines on PA 6400 Code
                                                </h2>

                                                <p className="mt-4 text-sm/relaxed">
                                                    HaliPro is easy to use and will get you done with compliance in a breeze.
                                                </p>
                                            </div>
                                        </div>
                                ...
                                >
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            HaliPro is designed to be easy to use by any one willing to implement the the compliance
                                ...
                                >
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            HaliPro features reminders and notifications to start internal audit processes
                                            for the purpose of preparations for external audit or just to maintain standards.
                                        </p>
                                    </div>
                                ...
                                <div className="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800">
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            HaliPro offers comprehensive user support. In case of any issues, please contact us
                                            at info@halihealthservices.com.
                                        </p>
                                    </div>
                                </div>
                            </div>
